...
Aplikasi menggunakan soft delete untuk menjaga integritas data:
- Unit tidak dapat dihapus jika status disewa atau memiliki penyewaan aktif
- Tenant tidak dapat dihapus jika memiliki penyewaan aktif
- Semua query memfilter data dengan `is_deleted = false`